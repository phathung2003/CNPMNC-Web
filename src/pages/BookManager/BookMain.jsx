                        ...
                        <tbody>
                            {
                                rentList.length != 0 ? rentList.map((info) => {
                                    return <tr key={info._id}>
                                        ...
                                        <td style={{ textAlign: "center", width: "10vw" }}>{info.IDKH.SoDienThoai}</td>
                                        ...
                                        <td style={{ textAlign: "center", width: "9vw" }}>{info.IDXe.TinhTrang}</td>
                                        <td className='h-grid col-3 mx-auto'>
                                            ...
                                            <button className="btn btn-success ml-1" onClick={(e) => {
