            ...
            <div>
                <div className="container light-style flex-grow-1 container-p-y">
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <h3 className="flex align-middle"><span className="text-lg mt-1"><span className="font-bold">Mã đơn: </span> {formData.IDDon} - </span><span className="ml-1 mr-1">Chi tiết đơn đặt trước</span></h3>
                    </div>
