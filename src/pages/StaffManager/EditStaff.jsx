                                        ...
                                        < div className="card-body">
                                            <div className="form-group row mt-1">
                                                ...
                                                <div className="col">
                                                    ...
                                                    <input className="form-control" type="text" autoComplete="off" name="TenXe" defaultValue={formData.TenNV} onChange={Input} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="form-group row mt-1">
                                                ...
                                                <div className="col">
                                                    ...
                                                    <input className="form-control" type="text" autoComplete="off" name="SDT" defaultValue={formData.SoDienThoai} onChange={Input} />
                                                </div>
